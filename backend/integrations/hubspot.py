...
CLIENT_ID = 'dfa44caa-5b28-45c6-ada5-eb884a42e2bd'  
CLIENT_SECRET = 'bf8a0f78-416e-4d9d-bbf6-24c4bfac619b'   
...
authorization_url = f'https://app-na2.hubspot.com/oauth/authorize?client_id={CLIENT_ID}&redirect_uri={REDIRECT_URI}&scope=oauth&optional_scope=crm.objects.contacts.read'
